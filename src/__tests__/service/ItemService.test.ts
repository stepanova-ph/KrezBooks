...
describe("ItemService", () => {
	...
	describe("create", () => {
		it("should create a new item with all fields", async () => {
			const newItem: CreateItemInput = {
				...
				vat_rate: 2,
				unit_of_measure: "ks",
				sale_price_group1: 100.0,
				sale_price_group2: 95.0,
				sale_price_group3: 90.0,
				sale_price_group4: 85.0,
			};
		...
		it("should create item with minimal required fields", async () => {
			const minimalItem: CreateItemInput = {
				...
				vat_rate: 2,
				unit_of_measure: "ks",
				sale_price_group1: 50.0,
				sale_price_group2: 50.0,
				sale_price_group3: 50.0,
				sale_price_group4: 50.0,
			};
		...
		it("should throw error for duplicate EAN", async () => {
			const item: CreateItemInput = {
				...
				unit_of_measure: "ks",
				sale_price_group1: 100.0,
				sale_price_group2: 100.0,
				sale_price_group3: 100.0,
				sale_price_group4: 100.0,
			};
		...
		it("should handle null optional fields correctly", async () => {
			const item: CreateItemInput = {
				...
				vat_rate: 2,
				unit_of_measure: "l",
				sale_price_group1: 75.5,
				sale_price_group2: 75.5,
				sale_price_group3: 75.5,
				sale_price_group4: 75.5,
			};
		...
		it("should handle different price groups", async () => {
			const item: CreateItemInput = {
				...
				unit_of_measure: "ks",
				sale_price_group1: 100.0,
				sale_price_group2: 90.0,
				sale_price_group3: 80.0,
				sale_price_group4: 70.0,
			};

			await itemService.create(item);

			const retrieved = await itemService.getOne("3333333333333");
			expect(retrieved?.sale_price_group1).toBe(100.0);
			expect(retrieved?.sale_price_group2).toBe(90.0);
			expect(retrieved?.sale_price_group3).toBe(80.0);
			expect(retrieved?.sale_price_group4).toBe(70.0);
		});
		...
		it("should handle decimal prices correctly", async () => {
			const item: CreateItemInput = {
				...
				sale_price_group3: 115.0,
				sale_price_group4: 110.5,
			};
	...
	describe("getAll", () => {
		...
		it("should include all item fields", async () => {
			const fullItem: CreateItemInput = {
				...
				vat_rate: 2,
				unit_of_measure: "m",
				sale_price_group1: 200.0,
				sale_price_group2: 180.0,
				sale_price_group3: 160.0,
				sale_price_group4: 140.0,
			};
	...
	describe("getOne", () => {
		...
		it("should return item by EAN", async () => {
			const newItem: CreateItemInput = {
				...
				vat_rate: 2,
				unit_of_measure: "ks",
				sale_price_group1: 150.0,
				sale_price_group2: 150.0,
				sale_price_group3: 150.0,
				sale_price_group4: 150.0,
			};
	...
	describe("update", () => {
		it("should update item fields", async () => {
			...
			expect(updated?.sale_price_group1).toBe(120.0);
			expect(updated?.sale_price_group2).toBe(100.0); // Unchanged
		});
		...
		it("should update all price groups", async () => {
			...
			const updates = {
				sale_price_group1: 110.0,
				sale_price_group2: 105.0,
				sale_price_group3: 100.0,
				sale_price_group4: 95.0,
			};

			await itemService.update("1010101010101", updates);

			const updated = await itemService.getOne("1010101010101");
			expect(updated?.sale_price_group1).toBe(110.0);
			expect(updated?.sale_price_group2).toBe(105.0);
			expect(updated?.sale_price_group3).toBe(100.0);
			expect(updated?.sale_price_group4).toBe(95.0);
		});
		...
		it("should throw error when no fields to update", async () => {
			...
			await expect(itemService.update("3030303030303", {})).rejects.toThrow(
				"No fields to update",
			);
		});
	...
	describe("delete", () => {
		...
		it("should throw error when deleting non-existent item", async () => {
			await expect(itemService.delete("9999999999999")).rejects.toThrow();
		});
	});
});
